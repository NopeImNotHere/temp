...
class LessonPaginator {
	...
	getDisplayElements(objectIndex) {
		...
		weeklyLessonHours.addEventListener("focusout", changeInfoOfLesson(this, "Wochenstunden"));
		...
		turnus.onchange = () => {
			changeInfoOfLesson(this, "Turnus");
		}
		...
		schoolyear.onchange = () => {
			changeInfoOfLesson(this, "Schuljahr");
		}
		...
		hinweiseArea.addEventListener("focusout", changeInfoOfLesson(this, "Zusatzinformation"))
...
function changeInfoOfLesson(element, type) {
	const table = element.parentNode.parentNode;
	console.log(table);
}
