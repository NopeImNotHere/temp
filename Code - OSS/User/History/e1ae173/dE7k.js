...
class LessonPaginator {
	...
	getDisplayElements(objectIndex) {
		...
		weeklyLessonHours.addEventListener("focusout", () => { changeInfoOfLesson(weeklyLessonHours, "Wochenstunden") });
		...
		hinweiseArea.addEventListener("focusout", () => { changeInfoOfLesson(hinweiseArea, "Zusatzinformation") })
